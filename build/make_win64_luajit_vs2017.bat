call "D:\Program Files (x86)\Microsoft Visual Studio\2017\Community\Common7\Tools\VsDevCmd.bat" -arch=amd64
...
cmake -DPBC=ON -DLUAC_COMPATIBLE_FORMAT=ON -DUSING_LUAJIT=ON -G "Visual Studio 15 2017 Win64" ..
popd
